...
birdsRight = [pygame.image.load('animation_frames\\bird\\bird-01.png'),
              pygame.image.load('animation_frames\\bird\\bird-02.png'),
              pygame.image.load('animation_frames\\bird\\bird-03.png'),
              pygame.image.load('animation_frames\\bird\\bird-04.png')]
birdsLeft = [pygame.image.load('animation_frames\\bird\\bird-01.png'),
              pygame.image.load('animation_frames\\bird\\bird-02.png'),
              pygame.image.load('animation_frames\\bird\\bird-03.png'),
              pygame.image.load('animation_frames\\bird\\bird-04.png')]
