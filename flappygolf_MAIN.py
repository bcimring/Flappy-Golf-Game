...
rule_button = pygame.image.load('rule_button.jpg')                  
...
levelButton = pygame.image.load('levels.png')
...
sunnyImgs = ['grass.png','dirt.png','sand.png','water.jpg','hole1.png','hole2.png','flag.png','background.png','waterWarning.png']              # images to load for regular levels
darkImgs = ['rockDirtTop.png','rockDirt.png','obsid.png','lava.png','hole1.png','hole2.png','flag.png','hellBackground.png','lavaWarning.png']  # images to load for bonus level
####################################
#   Game Images                    #
####################################
...
for i in range(12):                                                     # for loop for loading explosion images
    explosions.append(pygame.image.load('Explosion'+str(i+1)+'.png'))   # load and append image to list
...
pygame.mixer.Channel(2).play(pygame.mixer.Sound('ilty.wav'),-1) # start beatles song paused
pygame.mixer.Channel(2).set_volume(0.2)                         # at 20% volume
pygame.mixer.Channel(2).pause()                                 #
pygame.mixer.Channel(1).play(pygame.mixer.Sound('Jammin.wav'),-1)# start bob marley
